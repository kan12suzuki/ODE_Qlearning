...
#endif
#define NUM 4                          // リンク数
#define F "./Qtable_6p_18/Sumrewards.csv"
#define F2 "./Qtable_6p_18/ep_vs_st.csv"
#define F3 "./Qtable_6p_18/Qtable.csv"
#define F4 "./Qtable_6p_18/eval_Rewards.csv"
#define F5 "./Qtable_6p_18/Qtable_episode" 
double t = 0.0;
        ...
        if (env.terminate() || t == max_number_of_steps-1){
          ...
          sumReward = 0.0;
            ...
            // --- write per-episode metrics (min pair distance, mean pair distance, sep_score, mean nearest) ---
            {
              ...
              if (episode == 1){
                std::ofstream mhead("./Qtable_6p_18/metrics.csv", std::ios::app);
                mhead << "episode,min_pair,mean_pair,sep_score,mean_min_dist\n";
                mhead.close();
              }
              std::ofstream mfile("./Qtable_6p_18/metrics.csv", std::ios::app);
